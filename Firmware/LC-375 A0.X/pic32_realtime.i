# 1 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.c"
# 1 "E:\\Dropbox\\Electro\\Projects\\AQCA\\Light-Module\\Firmware\\LC-375 A0.X//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.c"
# 14 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.c"
# 1 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.h" 1
# 19 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.h"
# 1 "../hardware.h" 1
# 17 "../hardware.h"
...
# 21 "../hardware.h" 2
# 20 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.h" 2


# 1 "E:/Dropbox/Electro/Dev/PIClib/lib/peripheral/pic32_timer.h" 1
# 23 "E:/Dropbox/Electro/Dev/PIClib/lib/peripheral/pic32_timer.h"
# 1 "E:/Dropbox/Electro/Dev/PIClib/lib/peripheral/pic32_clock.h" 1
# 27 "E:/Dropbox/Electro/Dev/PIClib/lib/peripheral/pic32_clock.h"
...
# 24 "E:/Dropbox/Electro/Dev/PIClib/lib/peripheral/pic32_timer.h" 2
...
# 23 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.h" 2
...
# 24 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.h" 2
# 61 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.h"
typedef enum
{
 january = 0,
 february = 1,
...
# 116 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.h"
void rtISR(void);
# 128 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.h"
U8 realTimeInit(U32 tickPeriod);
# 137 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.h"
void rtTimeClear(tRealTime * timeToClear);
# 146 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.h"
void rtTimeEngine(void);
# 161 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.h"
U8 softCntInit(U32 cntPeriod, U32 * targetPtr, U32 targetValue, U8 option);
# 170 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.h"
void softCntRelease(U8 softCntID);
# 180 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.h"
void softCntEngine(void);
# 189 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.h"
void softCntStart(U8 softCntID);
# 198 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.h"
void softCntStop(U8 softCntID);
# 208 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.h"
void softCntUpdatePeriod(U8 softCntID, U32 newPeriod);
# 217 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.h"
void softCntReload(U8 softCntID);
# 229 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.h"
void upTimeUpdate(void);
# 238 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.h"
void upTimeSet(tRealTime * newTime);
# 247 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.h"
tRealTime* upTimeGet(void);
# 259 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.h"
void rtccUpdate(void);
# 15 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.c" 2
# 25 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.c"
U32 sysTick = 0;
U32 sysTickValue = 0;



const U8 dayPerMonth[12] = {31,28,31,30,31,30,31,31,30,31,30,31};
tFSMState rtccEngineState = unknown;
U8 rtccEngineSoftCntID = 16;
U32 rtccEngineFlag = 0;
U8 rtccEngineUpdatePtr = 0;
...
U32 softCnt[10];
U32 softCntReloadVal[10];
U32 * softCntTargetPtr[10];
U32 softCntTargetVal[10];
tSoftCounterControl softCntControl[10];
U8 softCntEnabled = 0;
U16 softCntEnable = 0;
U16 softCntRun = 0;
# 85 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.c"
void rtISR(void)
{
 sysTick++;
 ...
 while (softCntRun >> wu0)
 {
  if (softCntRun & ((1 << 0) << wu0))
  {
   if (softCnt[wu0])
    softCnt[wu0]--;
   else
...
# 121 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.c"
U8 realTimeInit(U32 tickPeriod)
{

 timerInit(0,0|0x200);
 timerSetOverflow(0,tickPeriod);
 (((IPC1bits.T1IP)) = (7));
 (((IPC1bits.T1IS)) = (3));
 (((IEC0SET)) = ((1 << 4)));
...
# 156 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.c"
void rtTimeClear(tRealTime * timeToClear)
{
 U8 wu0 = 0;
 U32 * workPtr = (U32*)timeToClear;

 if (timeToClear != ((void *)0))
 {
  for (; wu0 < (sizeof(tRealTime)/4) ; wu0++)
   workPtr[wu0] = 0;
 }
}
# 175 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.c"
void rtTimeEngine(void)
{
 switch (rtccEngineState)
 {
  ...
  case unknown:
  {
   ...
   if (rtccEngineSoftCntID != 16)
    softCntRelease(rtccEngineSoftCntID);


   rtccEngineSoftCntID = softCntInit(1000, &rtccEngineFlag, 0xFF, 0x1 +0x2);
  ...
  case init:
  {
   softCntStart(rtccEngineSoftCntID);
  ...
  case busy:
  {
   ...
   if (rtccEngineFlag)
   {
    ...
    {
     case 0: rtccUpdate(); break;
     case 1: upTimeUpdate(); break;
    }
...
# 239 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.c"
U8 softCntInit(U32 cntPeriod, U32 * targetPtr, U32 targetValue, U8 option)
{
 U8 softCntID;


 if (softCntEnabled < 10)

 {
  ...
  softCntControl[softCntID].targetEn = (option & 0x2) >> 1;
  ...
  softCntStop(softCntID);
  softCntEnable |= ((1 << 0) << softCntID);
  softCntControl[softCntID].reload = option & 0x1;
...
# 283 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.c"
void softCntRelease(U8 softCntID)
{

 if ((softCntEnable) & ((1 << 0) << softCntID))
 {
  softCntStop(softCntID);
  softCntEnable &= ~((1 << 0) << softCntID);


  while (!((softCntEnable) & ((1 << 0) << (softCntEnabled - 1))))
   softCntEnabled--;

 }

}
# 307 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.c"
void softCntEngine(void)
{
 U8 softCntIDtemp = 0;

 while ((softCntEnable) & ((65535) << softCntIDtemp))
 {
  ...
  if (softCntControl[softCntIDtemp].underRun)
  {
   ...
   if (softCntControl[softCntIDtemp].reload)
    softCnt[softCntIDtemp] = softCntReloadVal[softCntIDtemp];
   else
    softCntStop(softCntIDtemp);



   if (softCntControl[softCntIDtemp].targetEn)
   {
    U32 targetTemp = *softCntTargetPtr[softCntIDtemp];
    targetTemp &= ~(softCntTargetVal[softCntIDtemp]);
    targetTemp |= softCntTargetVal[softCntIDtemp];
    *softCntTargetPtr[softCntIDtemp] = targetTemp;
   }


   softCntControl[softCntIDtemp].underRun = 0;
  }
...
# 348 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.c"
void softCntStart(U8 softCntID)
{

 softCntRun |= ((1 << 0) << softCntID);
}
# 361 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.c"
void softCntStop(U8 softCntID)
{
 softCntRun &= ~((1 << 0) << softCntID);
}
# 374 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.c"
void softCntUpdatePeriod(U8 softCntID, U32 newPeriod)
{
 softCntReloadVal[softCntID] = newPeriod;
}
# 386 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.c"
void softCntReload(U8 softCntID)
{
 softCnt[softCntID] = softCntReloadVal[softCntID];
}
# 401 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.c"
void upTimeUpdate(void)
{
 U32 uStemp = upTimeRemaininguS + ((sysTick - upTimeLast) * sysTickValue);
...
# 451 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.c"
void upTimeSet(tRealTime * newTime)
{
 U8 wu0;
...
# 470 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.c"
tRealTime* upTimeGet(void)
{
 return &upTime;
}
# 485 "../../../../../Dev/PIClib/lib/soft/pic32_realtime.c"
void rtccUpdate(void)
{

 U32 uStemp = rtccRemaininguS + ((sysTick - rtccTimeLast) * sysTickValue);

 rtccTimeLast = sysTick;
