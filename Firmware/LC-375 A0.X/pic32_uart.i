# 1 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c"
# 1 "E:\\Dropbox\\Electro\\Projects\\AQCA\\Light-Module\\Firmware\\LC-375 A0.X//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c"
# 17 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c"
# 1 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h" 1
# 20 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h"
# 1 "../hardware.h" 1
# 17 "../hardware.h"
...
# 21 "../hardware.h" 2
# 21 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h" 2
...
# 59 "E:/Dropbox/Electro/Dev/PIClib/lib/peripheral/pic32_interrupt.h"
# 1 "E:/Dropbox/Electro/Dev/PIClib/lib/peripheral/pic32_cpu.h" 1
# 26 "E:/Dropbox/Electro/Dev/PIClib/lib/peripheral/pic32_cpu.h"
...
# 27 "E:/Dropbox/Electro/Dev/PIClib/lib/peripheral/pic32_cpu.h" 2
# 62 "E:/Dropbox/Electro/Dev/PIClib/lib/peripheral/pic32_cpu.h"
void cpuSoftReset(void);
# 60 "E:/Dropbox/Electro/Dev/PIClib/lib/peripheral/pic32_interrupt.h" 2
...
# 24 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h" 2
...
# 25 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h" 2
# 118 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h"
typedef union
{
 U32 all;
 struct
...
# 251 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h"
void uartISR(U8 uartID);
# 266 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h"
void uartSetConfig(U8 uartPort, U64 uartLocalConfig);
# 275 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h"
tUARTConfig uartGetConfig(U8 uartPort);
# 287 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h"
U8 uartInit(U8 uartPort, U32 option);
# 299 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h"
U8 uartSetBaudRate(U8 uartPort, U32 baudRate);
# 308 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h"
U32 uartGetBaudRate(U8 uartPort);
# 318 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h"
U8 uartSetAddressMask(U8 uartPort, U8 addressMask);
# 327 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h"
U8 uartGetAddressMask(U8 uartPort);
# 336 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h"
U16 uartGetRxSize(U8 uartPort);
# 345 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h"
U16 uartGetRxSpace(U8 uartPort);
# 354 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h"
U16 uartGetTxSize(U8 uartPort);
# 363 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h"
U16 uartGetTxSpace(U8 uartPort);
# 376 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h"
U8 uartSetTxStatus(U8 uartPort, U8 state);
# 385 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h"
U8 uartGetTxStatus(U8 uartPort);
# 395 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h"
U8 uartSetRxStatus(U8 uartPort, U8 state);
# 404 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h"
U8 uartGetRxStatus(U8 uartPort);
# 417 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h"
U8 uartSendByte(U8 uartPort, U8 byteToSend);
# 426 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h"
U8 uartRcvByte(U8 uartPort);
# 439 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h"
U16 uartSendArray(U8 uartPort, U8 * sourcePtr, U16 byteNb);
# 452 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.h"
U16 uartRcvArray(U8 uartPort, U8 * destinationPtr, U16 byteNb);
# 18 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c" 2




extern U32 globalDump;
tUARTConfig uartConfig[2];


tRBufCtl * uartRxBuf[2];
tRBufCtl * uartTxBuf[2];


tUxMODE * pUxMODE = ((void *)0);
tUxSTA * pUxSTA = ((void *)0);
volatile U32 * pUxRXREG = ((void *)0);
volatile U32 * pUxTXREG = ((void *)0);
volatile U32 * pUxBRG = ((void *)0);
...
# 53 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c"
U8 uartSelectPort(U8 uartPort)
{

 switch (uartPort)
 {
  case 0: pUxMODE = (tUxMODE*)&U1MODE; pUxSTA = (tUxSTA*)&U1STA; pUxBRG = &U1BRG; pUxRXREG = &U1RXREG; pUxTXREG = &U1TXREG; break;
  case 1: pUxMODE = (tUxMODE*)&U2MODE; pUxSTA = (tUxSTA*)&U2STA; pUxBRG = &U2BRG; pUxRXREG = &U2RXREG; pUxTXREG = &U2TXREG; break;
...
# 84 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c"
void uartISR(U8 uartID)
{
 U32 interruptCheck = _intGetReg(&IFS0,UART_INT[uartID]);
 U16 byteNb = 0;
 static U8 tempBuf[8 +2];

 if (uartSelectPort(uartID) == 0)
 {

  if (interruptCheck & (1 << 1))
  {

   while (pUxSTA->URXDA)
   {

    if (pUxSTA->all & ((1 << 3)|(1 << 2)))
     globalDump = *pUxRXREG;
   ...
   rBufPushU8(uartRxBuf[uartID], tempBuf, byteNb, 0);

  }



  if (interruptCheck & (1 << 2))
  {
   ...
   else
   {
    ...
    rBufPullU8(uartTxBuf[uartID], pUxTXREG, byteNb, 1);
   }
...
# 185 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c"
void uartSetConfig(U8 uartPort, U64 uartLocalConfig)
{
 uartConfig[uartPort].all = uartLocalConfig;
}
# 197 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c"
tUARTConfig uartGetConfig(U8 uartPort)
{
 return uartConfig[uartPort];
}
# 212 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c"
U8 uartInit(U8 uartPort, U32 option)
{
...

 {
  ...
  uartRxBuf[uartPort] = rBufCreate(256,sizeof(U8));
  if (uartRxBuf[uartPort] == ((void *)0))
   errorCode = 1;

  uartTxBuf[uartPort] = rBufCreate(256,sizeof(U8));



  pUxMODE->STSEL = splittedOption.b0;
  pUxMODE->PDSEL = (option & 0x6)>>1;
  pUxMODE->RXINV = splittedOption.b4;
  pUxMODE->LPBACK = splittedOption.b6;
  pUxMODE->WAKE = splittedOption.b7;
  pUxMODE->RTSMD = splittedOption.b11;
  pUxMODE->IREN = splittedOption.b12;
  pUxMODE->SIDL = splittedOption.b13;

  pUxSTA->ADDEN = splittedOption.b3;
  pUxSTA->ADM_EN = splittedOption.b3;
  pUxSTA->UTXISEL = (option & 0xC000)>>14;
  pUxSTA->URXISEL = (option & 0x3000)>>12;

  if (pUxMODE->IREN)
   pUxSTA->UTXINV = !splittedOption.b5;
  else
   pUxSTA->UTXINV = splittedOption.b5;
...
# 271 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c"
U8 uartSetBaudRate(U8 uartPort, U32 baudRate)
{
 U8 divider = 4;
 U8 uartSaveState;
...
# 318 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c"
U32 uartGetBaudRate(U8 uartPort)
{
 U8 divider = 16;
 U32 baudRate = 0;
 ...
 switch (uartPort)
 {
  case 0: pUxMODE = (tUxMODE*)&U1MODE; pUxBRG = (U32*)&U1BRG; break;
  case 1: pUxMODE = (tUxMODE*)&U2MODE; pUxBRG = (U32*)&U2BRG; break;
...
# 356 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c"
U8 uartSetAddressMask(U8 uartPort, U8 addressMask)
{

 switch (uartPort)
 {
  case 0: U1STAbits.ADDR = addressMask; break;
  case 1: U2STAbits.ADDR = addressMask; break;
...
# 383 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c"
U8 uartGetAddressMask(U8 uartPort)
{

 switch (uartPort)
 {
  case 0: return U1STAbits.ADDR;
  case 1: return U2STAbits.ADDR;
...
# 408 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c"
U16 uartGetRxSize(U8 uartPort)
{
 return rBufGetUsedSpace(uartRxBuf[uartPort]);
}
# 420 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c"
U16 uartGetRxSpace(U8 uartPort)
{
 return rBufGetFreeSpace(uartRxBuf[uartPort]);
}
# 432 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c"
U16 uartGetTxSize(U8 uartPort)
{
 return rBufGetUsedSpace(uartTxBuf[uartPort]);
}
# 444 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c"
U16 uartGetTxSpace(U8 uartPort)
{
 return rBufGetFreeSpace(uartTxBuf[uartPort]);
}
# 460 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c"
U8 uartSetTxStatus(U8 uartPort, U8 state)
{
...
# 477 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c"
U8 uartGetTxStatus(U8 uartPort)
{
 if (uartSelectPort(uartPort) == 0)
  return pUxSTA->UTXEN;
}
# 491 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c"
U8 uartSetRxStatus(U8 uartPort, U8 state)
{
 U8 errorCode = uartSelectPort(uartPort);
...
# 508 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c"
U8 uartGetRxStatus(U8 uartPort)
{
 if (uartSelectPort(uartPort) == 0)
  return pUxSTA->URXEN;
}
# 525 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c"
U8 uartSendByte(U8 uartPort,U8 byteToSend)
{
 U8 errorCode;


 errorCode = rBufPushU8(uartTxBuf[uartPort], &byteToSend, 1, 0);
...
# 553 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c"
U8 uartRcvByte(U8 uartPort)
{
 static U8 receivedByte;

 rBufPullU8(uartRxBuf[uartPort], &receivedByte, 1, 0);

 return receivedByte;
}
# 573 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c"
U16 uartSendArray(U8 uartPort, U8 * sourcePtr, U16 byteNb)
{
 U8 errorCode;


 errorCode = rBufPushU8(uartTxBuf[uartPort], sourcePtr, byteNb, 0);
...
# 607 "../../../../../Dev/PIClib/lib/peripheral/pic32_uart.c"
U16 uartRcvArray(U8 uartPort, U8 * destinationPtr, U16 byteNb)
{
 ...
 rBufPullU8(uartRxBuf[uartPort], destinationPtr, byteNb, 0);
