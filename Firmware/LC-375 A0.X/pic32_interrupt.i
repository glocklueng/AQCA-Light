# 1 "../../../../../Dev/PIClib/lib/peripheral/pic32_interrupt.c"
# 1 "E:\\Dropbox\\Electro\\Projects\\AQCA\\Light-Module\\Firmware\\LC-375 A0.X//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../../../Dev/PIClib/lib/peripheral/pic32_interrupt.c"
# 17 "../../../../../Dev/PIClib/lib/peripheral/pic32_interrupt.c"
# 1 "../../../../../Dev/PIClib/lib/peripheral/pic32_interrupt.h" 1
# 56 "../../../../../Dev/PIClib/lib/peripheral/pic32_interrupt.h"
# 1 "../hardware.h" 1
# 17 "../hardware.h"
...
# 21 "../hardware.h" 2
# 57 "../../../../../Dev/PIClib/lib/peripheral/pic32_interrupt.h" 2
...
# 60 "../../../../../Dev/PIClib/lib/peripheral/pic32_interrupt.h" 2
...
# 68 "../../../../../Dev/PIClib/lib/peripheral/pic32_interrupt.h" 2
# 323 "../../../../../Dev/PIClib/lib/peripheral/pic32_interrupt.h"
typedef enum
{
 CP0E_interrupt = 0,
...
# 843 "../../../../../Dev/PIClib/lib/peripheral/pic32_interrupt.h"
void intSetPriority(tIntIRQ intIRQSource, U8 priorityLvl, U8 subPriorityLvl);
# 852 "../../../../../Dev/PIClib/lib/peripheral/pic32_interrupt.h"
U8 intGetPriority(tIntIRQ intIRQSource);
# 861 "../../../../../Dev/PIClib/lib/peripheral/pic32_interrupt.h"
U8 intGetSubPriority(tIntIRQ intIRQSource);
# 871 "../../../../../Dev/PIClib/lib/peripheral/pic32_interrupt.h"
void intSetExternalEdge(tIntIRQ intIRQSource, U8 edgeDirection);
# 883 "../../../../../Dev/PIClib/lib/peripheral/pic32_interrupt.h"
void _general_exception_handler(void);
# 2217 "../../../../../Dev/PIClib/lib/peripheral/pic32_interrupt.h"
void _intSetReg(volatile U32 * regPtr, tIntIRQ intIRQSource, U8 state);
# 2227 "../../../../../Dev/PIClib/lib/peripheral/pic32_interrupt.h"
U8 _intGetReg(volatile U32 * regPtr, tIntIRQ intIRQSource);
# 18 "../../../../../Dev/PIClib/lib/peripheral/pic32_interrupt.c" 2
# 41 "../../../../../Dev/PIClib/lib/peripheral/pic32_interrupt.c"
void _intSetReg(volatile U32 * regPtr, tIntIRQ intIRQSource, U8 state)
{
 U8 maskTemp = (1 << 0);
...
# 77 "../../../../../Dev/PIClib/lib/peripheral/pic32_interrupt.c"
U8 _intGetReg(volatile U32 * regPtr, tIntIRQ intIRQSource)
{
 U8 maskTemp = (1 << 0);
...
# 111 "../../../../../Dev/PIClib/lib/peripheral/pic32_interrupt.c"
void intSetPriority(tIntIRQ intIRQSource, U8 priorityLvl, U8 subPriorityLvl)
{
 subPriorityLvl &= 0x3;
 priorityLvl &= 0x7;
 ...
 switch (intIRQSource)
 {
  case IRQ_CORE_TIMER: (IPC0bits.CTIP) = priorityLvl; (IPC0bits.CTIS) = subPriorityLvl; break;
  case IRQ_CORE_SOFT_0: (IPC0bits.CS0IP) = priorityLvl; (IPC0bits.CS0IS) = subPriorityLvl; break;
  case IRQ_CORE_SOFT_1: (IPC0bits.CS1IP) = priorityLvl; (IPC0bits.CS1IS) = subPriorityLvl; break;
  case IRQ_EXT_INT_0: (IPC0bits.INT0IP) = priorityLvl; (IPC0bits.INT0IS) = subPriorityLvl; break;
  case IRQ_TIMER_1: (IPC1bits.T1IP) = priorityLvl; (IPC1bits.T1IS) = subPriorityLvl; break;
  case IRQ_INPUT_CAPTURE_1: (IPC1bits.IC1IP) = priorityLvl; (IPC1bits.IC1IS) = subPriorityLvl; break;
  case IRQ_OUTPUT_COMPARE_1: (IPC1bits.OC1IP) = priorityLvl;(IPC1bits.OC1IS) = subPriorityLvl; break;
  case IRQ_EXT_INT_1: (IPC1bits.INT1IP) = priorityLvl; (IPC1bits.INT1IS) = subPriorityLvl; break;
  case IRQ_TIMER_2: (IPC2bits.T2IP) = priorityLvl; (IPC2bits.T2IS) = subPriorityLvl; break;
  case IRQ_INPUT_CAPTURE_2: (IPC2bits.IC2IP) = priorityLvl; (IPC2bits.IC2IS) = subPriorityLvl; break;
  case IRQ_OUTPUT_COMPARE_2: (IPC2bits.OC2IP) = priorityLvl;(IPC2bits.OC2IS) = subPriorityLvl; break;
  case IRQ_EXT_INT_2: (IPC2bits.INT2IP) = priorityLvl; (IPC2bits.INT2IS) = subPriorityLvl; break;
  case IRQ_TIMER_3: (IPC3bits.T3IP) = priorityLvl; (IPC3bits.T3IS) = subPriorityLvl; break;
  case IRQ_INPUT_CAPTURE_3: (IPC3bits.IC3IP) = priorityLvl; (IPC3bits.IC3IS) = subPriorityLvl; break;
  case IRQ_OUTPUT_COMPARE_3: (IPC3bits.OC3IP) = priorityLvl;(IPC3bits.OC3IS) = subPriorityLvl; break;
  case IRQ_EXT_INT_3: (IPC3bits.INT3IP) = priorityLvl; (IPC3bits.INT3IS) = subPriorityLvl; break;
  case IRQ_TIMER_4: (IPC4bits.T4IP) = priorityLvl; (IPC4bits.T4IS) = subPriorityLvl; break;
  case IRQ_INPUT_CAPTURE_4: (IPC4bits.IC4IP) = priorityLvl; (IPC4bits.IC4IS) = subPriorityLvl; break;
  case IRQ_OUTPUT_COMPARE_4: (IPC4bits.OC4IP) = priorityLvl;(IPC4bits.OC4IS) = subPriorityLvl; break;
  case IRQ_EXT_INT_4: (IPC4bits.INT4IP) = priorityLvl; (IPC4bits.INT4IS) = subPriorityLvl; break;
  case IRQ_TIMER_5: (IPC5bits.T5IP) = priorityLvl; (IPC5bits.T5IS) = subPriorityLvl; break;
  case IRQ_INPUT_CAPTURE_5: (IPC5bits.IC5IP) = priorityLvl; (IPC5bits.IC5IS) = subPriorityLvl; break;
  case IRQ_OUTPUT_COMPARE_5: (IPC5bits.OC5IP) = priorityLvl;(IPC5bits.OC5IS) = subPriorityLvl; break;

  case IRQ_SPI_1: (IPC7bits.SPI1IP) = priorityLvl; (IPC7bits.SPI1IS) = subPriorityLvl; break;
  case IRQ_SPI_2: (IPC9bits.SPI2IP) = priorityLvl; (IPC9bits.SPI2IS) = subPriorityLvl; break;




  case IRQ_UART_1: (IPC8bits.U1IP) = priorityLvl; (IPC8bits.U1IS) = subPriorityLvl; break;
  case IRQ_UART_2: (IPC9bits.U2IP) = priorityLvl; (IPC9bits.U2IS) = subPriorityLvl; break;
  ...
  case IRQ_I2C_1: (IPC8bits.I2C1IP) = priorityLvl; (IPC8bits.I2C1IS) = subPriorityLvl; break;
  case IRQ_I2C_2: (IPC9bits.I2C2IP) = priorityLvl; (IPC9bits.I2C2IS) = subPriorityLvl; break;





  case IRQ_INPUT_CHANGE: (IPC8bits.CNIP) = priorityLvl; (IPC8bits.CNIS) = subPriorityLvl; break;
  case IRQ_ADC_1: (IPC5bits.AD1IP) = priorityLvl; (IPC5bits.AD1IS) = subPriorityLvl; break;
  case IRQ_PMP: (IPC8bits.PMPIP) = priorityLvl; (IPC8bits.PMPIS) = subPriorityLvl; break;
  case IRQ_PMP_ERR: (IPC8bits.PMPIP) = priorityLvl; (IPC8bits.PMPIS) = subPriorityLvl; break;
  case IRQ_COMPARATOR_1: (IPC6bits.CMP1IP) = priorityLvl; (IPC6bits.CMP1IS) = subPriorityLvl; break;
  case IRQ_COMPARATOR_2: (IPC7bits.CMP2IP) = priorityLvl; (IPC7bits.CMP2IS) = subPriorityLvl; break;
  case IRQ_FAIL_SAFE_CLOCK_MON: (IPC6bits.FSCMIP) = priorityLvl;(IPC6bits.FSCMIS) = subPriorityLvl;break;
  case IRQ_RTCC: (IPC6bits.RTCCIP) = priorityLvl; (IPC6bits.RTCCIS) = subPriorityLvl; break;
  case IRQ_DMA_0: (IPC10bits.DMA0IP) = priorityLvl; (IPC10bits.DMA0IS) = subPriorityLvl; break;
  case IRQ_DMA_1: (IPC10bits.DMA1IP) = priorityLvl; (IPC10bits.DMA1IS) = subPriorityLvl; break;
  case IRQ_DMA_2: (IPC10bits.DMA2IP) = priorityLvl; (IPC10bits.DMA2IS) = subPriorityLvl; break;
  case IRQ_DMA_3: (IPC10bits.DMA3IP) = priorityLvl; (IPC10bits.DMA3IS) = subPriorityLvl; break;
  ...
  case IRQ_FLASH_CONTROL_EVENT: (IPC6bits.FCEIP) = priorityLvl;(IPC6bits.FCEIS) = subPriorityLvl;break;
  ...
  case IRQ_INPUT_CAPTURE_1_ERR: (IPC1bits.IC1IP) = priorityLvl;(IPC1bits.IC1IS) = subPriorityLvl;break;
  case IRQ_INPUT_CAPTURE_2_ERR: (IPC2bits.IC2IP) = priorityLvl;(IPC2bits.IC2IS) = subPriorityLvl;break;
  case IRQ_INPUT_CAPTURE_3_ERR: (IPC3bits.IC3IP) = priorityLvl;(IPC3bits.IC3IS) = subPriorityLvl;break;
  case IRQ_INPUT_CAPTURE_4_ERR: (IPC4bits.IC4IP) = priorityLvl;(IPC4bits.IC4IS) = subPriorityLvl;break;
  case IRQ_INPUT_CAPTURE_5_ERR: (IPC5bits.IC5IP) = priorityLvl;(IPC5bits.IC5IS) = subPriorityLvl;break;
  default: return;
 }

}
# 210 "../../../../../Dev/PIClib/lib/peripheral/pic32_interrupt.c"
U8 intGetPriority(tIntIRQ intIRQSource)
{
 U32 * regPtr = (U32*)&IPC0;
 U8 returnPriority;
 ...
 regPtr += 0x4 * (((U8)intIRQSource)/4);
 intIRQSource %= 4;



 returnPriority = (*regPtr >> (intIRQSource << 3)) & ((1 << 4)|(1 << 3)|(1 << 2)) ;
 returnPriority >>= 2;


 return returnPriority;
}
# 235 "../../../../../Dev/PIClib/lib/peripheral/pic32_interrupt.c"
U8 intGetSubPriority(tIntIRQ intIRQSource)
{
 U32 * regPtr = (U32*)&IPC0;
 ...
 return (*regPtr >> (intIRQSource << 3)) & ((1 << 1)|(1 << 0));
}
# 255 "../../../../../Dev/PIClib/lib/peripheral/pic32_interrupt.c"
void intSetExternalEdge(tIntIRQ intIRQSource, U8 edgeDirection)
{
 switch (intIRQSource)
 {
...
# 278 "../../../../../Dev/PIClib/lib/peripheral/pic32_interrupt.c"
void _general_exception_handler (void)
{
 tCP0Error exceptionCause;
 U32 exceptionAddress;

 exceptionCause = (__builtin_mfc0(13,0) & 0x7C) >> 2;
 exceptionAddress = __builtin_mfc0(14,0);
