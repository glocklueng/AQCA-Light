# 1 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.c"
# 1 "E:\\Dropbox\\Electro\\Projects\\AQCA\\Light-Module\\Firmware\\LC-375 A0.X//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.c"
# 15 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.c"
# 1 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.h" 1
# 20 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.h"
# 1 "../hardware.h" 1
# 17 "../hardware.h"
...
# 21 "../hardware.h" 2
# 21 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.h" 2
...
# 24 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.h" 2
# 91 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.h"
typedef union
{
 U32 all;
 struct
...
# 144 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.h"
U8 timerInit(U8 timerPort, U32 option);
# 153 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.h"
void timerStart(U8 timerPort);
# 163 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.h"
void timerStop(U8 timerPort);
# 173 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.h"
U8 timerGetSize(U8 timerPort);
# 183 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.h"
U32 timerGetClock(U8 timerPort);
# 195 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.h"
U8 timerSetOverflow(U8 timerPort, F32 ovfPeriod);
# 205 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.h"
U32 timerGetOverflow(U8 timerPort);
# 215 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.h"
F32 timerGetCntPeriod(U8 timerPort);
# 226 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.h"
U8 timerSetPR(U8 timerPort, U32 PRvalue);
# 237 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.h"
U32 timerGetPR(U8 timerPort);
# 250 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.h"
void timerSet(U8 timerPort, U32 data);
# 262 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.h"
U32 timerGet(U8 timerPort);
# 272 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.h"
void timerClear(U8 timerPort);
# 16 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.c" 2
# 27 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.c"
tTCON * pTxCON = ((void *)0);
U32 * pPRx = ((void *)0);
U32 * pPR32x = ((void *)0);
...
const U16 tmrPrescalerValue[8] = {1,2,4,8,16,32,64,256};
const U16 tmr1PrescalerValue[4] = {1,8,64,256};
const U32 tmrMax[2] = {0xFFFF,0xFFFFFFFF};
# 48 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.c"
U8 timerSelectPort(U8 timerPort)
{
 switch (timerPort)
 {
  case 0: pTxCON = (tTCON*)&T1CON; pPRx = (U32*)&PR1; break;
  case 1: pTxCON = (tTCON*)&T2CON; pPRx = (U32*)&PR2; pPR32x = (U32*)&PR3; break;
  case 2: pTxCON = (tTCON*)&T3CON; pPRx = (U32*)&PR3; break;
  case 3: pTxCON = (tTCON*)&T4CON; pPRx = (U32*)&PR4; pPR32x = (U32*)&PR5; break;
  case 4: pTxCON = (tTCON*)&T5CON; pPRx = (U32*)&PR5; break;
  default: return 2;
 }
 return 0;
}
# 94 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.c"
U8 timerInit(U8 timerPort, U32 option)
{
...

 {
  ...
  if (timerPort == 0)
  {
   ...
   splittedOption.b1 = splittedOption.b2;
   pTxCON->TCKPS = splittedOption.all & 0x3;
...
# 156 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.c"
void timerStart(U8 timerPort)
{
 switch (timerPort)
 {
  case 0: T1CONSET = (1 << 15); break;
  case 1: T2CONSET = (1 << 15); break;
  case 2: T3CONSET = (1 << 15); break;
  case 3: T4CONSET = (1 << 15); break;
  case 4: T5CONSET = (1 << 15); break;
 }
}
# 175 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.c"
void timerStop(U8 timerPort)
{
 switch (timerPort)
 {
  case 0: T1CONCLR = (1 << 15); break;
  case 1: T2CONCLR = (1 << 15); break;
  case 2: T3CONCLR = (1 << 15); break;
  case 3: T4CONCLR = (1 << 15); break;
  case 4: T5CONCLR = (1 << 15); break;
 }
}
# 194 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.c"
U8 timerGetSize(U8 timerPort)
{
 switch (timerPort)
 {
  case 0: return 16;
  case 1: return ((T2CONbits.T32 << 4)+16);
  case 2: return ((T2CONbits.T32 << 4)+16);
  case 3: return ((T4CONbits.T32 << 4)+16);
  case 4: return ((T4CONbits.T32 << 4)+16);
  default: return 0;
 }
}
# 216 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.c"
U32 timerGetClock(U8 timerPort)
{
 U8 tempDivID = 0;
 ...
 if (timerSelectPort(timerPort) == 0)
...
# 251 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.c"
U8 timerSetOverflow(U8 timerPort, F32 ovfPeriod)
{
 U8 timerDivID;
 U8 timerDivIDmax = 8;
...
# 307 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.c"
U32 timerGetOverflow(U8 timerPort)
{
 F32 cntPeriod = 0;
...
# 332 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.c"
F32 timerGetCntPeriod(U8 timerPort)
{
 U16 * pDivTable = (U16*)tmrPrescalerValue;
...
# 359 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.c"
U8 timerSetPR(U8 timerPort, U32 PRvalue)
{
 U8 errorCode;
...
# 388 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.c"
U32 timerGetPR(U8 timerPort)
{
 U32 PRvalue = 0;
...
# 417 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.c"
void timerSet(U8 timerPort, U32 data)
{
 switch(timerPort)
 {
  case 0: (TMR1) = data; break;
  case 1: (TMR2) = data; break;
  case 2: (TMR3) = data; break;
  case 3: (TMR4) = data; break;
  case 4: (TMR5) = data; break;
 }
}
# 438 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.c"
U32 timerGet(U8 timerPort)
{
 switch(timerPort)
 {
...
# 458 "../../../../../Dev/PIClib/lib/peripheral/pic32_timer.c"
void timerClear(U8 timerPort)
{
 switch (timerPort)
 {
