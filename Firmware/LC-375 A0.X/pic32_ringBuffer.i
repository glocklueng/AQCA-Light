# 1 "../../../../../Dev/PIClib/lib/soft/pic32_ringBuffer.c"
# 1 "E:\\Dropbox\\Electro\\Projects\\AQCA\\Light-Module\\Firmware\\LC-375 A0.X//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../../../Dev/PIClib/lib/soft/pic32_ringBuffer.c"
# 17 "../../../../../Dev/PIClib/lib/soft/pic32_ringBuffer.c"
# 1 "../../../../../Dev/PIClib/lib/soft/pic32_ringBuffer.h" 1
# 20 "../../../../../Dev/PIClib/lib/soft/pic32_ringBuffer.h"
...
# 8 "c:\\program files (x86)\\microchip\\mplabc32\\v2.02\\bin\\../lib/gcc/pic32mx/4.5.1/../../../../pic32mx/include/stdlib.h" 2 3
...
# 21 "../../../../../Dev/PIClib/lib/soft/pic32_ringBuffer.h" 2
# 1 "E:/Dropbox/Electro/Dev/PIClib/lib/peripheral/pic32_interrupt.h" 1
# 56 "E:/Dropbox/Electro/Dev/PIClib/lib/peripheral/pic32_interrupt.h"
# 1 "../hardware.h" 1
# 17 "../hardware.h"
...
# 21 "../hardware.h" 2
# 57 "E:/Dropbox/Electro/Dev/PIClib/lib/peripheral/pic32_interrupt.h" 2
...
# 22 "../../../../../Dev/PIClib/lib/soft/pic32_ringBuffer.h" 2
# 47 "../../../../../Dev/PIClib/lib/soft/pic32_ringBuffer.h"
typedef struct
{
 struct
 {
...
tRBufCtl * rBufCreate(U16 elementNb, U16 elementSize)
{
 ...
 if (tempBufCtlPtr == ((void *)0))
  return ((void *)0);
 heapAvailable -= sizeof(tRBufCtl);



 if (elementSize > 2)
 {
  realElementSize = elementSize>>2;
  if (elementSize & 0x3)
   realElementSize++;
  realElementSize <<= 2;
 }
 ...
 tempBufCtlPtr->bufPtr = malloc(elementNb*realElementSize);
 if (tempBufCtlPtr->bufPtr == ((void *)0))
 {
  heapAvailable += sizeof(tRBufCtl);
  free(tempBufCtlPtr);
  return ((void *)0);
 }
 heapAvailable -= (elementNb*realElementSize);



 tempBufCtlPtr->control.elementNb = elementNb;
 tempBufCtlPtr->control.elementSize = realElementSize;

 tempBufCtlPtr->control.end = (tempBufCtlPtr->bufPtr)+(elementNb*realElementSize);
...
# 90 "../../../../../Dev/PIClib/lib/soft/pic32_ringBuffer.c"
U8 rBufResize(tRBufCtl * bufCtlPtr, U16 newElementNb)
{
 U8 errorCode;


 bufCtlPtr->status.writeLock = 1;
 bufCtlPtr->status.readLock = 1;
...

 {
  ...
  if (realloc(bufCtlPtr->bufPtr,(newElementNb*(bufCtlPtr->control.elementSize))) != ((void *)0))
  {
 ...
 bufCtlPtr->status.writeLock = 0;
 bufCtlPtr->status.readLock = 0;


 return 0;
}
# 131 "../../../../../Dev/PIClib/lib/soft/pic32_ringBuffer.c"
U8 rBufDelete(tRBufCtl * bufCtlPtr)
{
 ...
 heapAvailable += ((bufCtlPtr->control.elementNb)*(bufCtlPtr->control.elementSize));
...
# 159 "../../../../../Dev/PIClib/lib/soft/pic32_ringBuffer.c"
U16 rBufGetFreeSpace(tRBufCtl * bufCtlPtr)
{
 return bufCtlPtr->status.freeElement;
}
# 171 "../../../../../Dev/PIClib/lib/soft/pic32_ringBuffer.c"
U16 rBufGetUsedSpace(tRBufCtl * bufCtlPtr)
{
 return (bufCtlPtr->control.elementNb - bufCtlPtr->status.freeElement);
}
# 184 "../../../../../Dev/PIClib/lib/soft/pic32_ringBuffer.c"
U16 rBufGetElementSize(tRBufCtl * bufCtlPtr)
{
 return bufCtlPtr->control.elementSize;
}
# 197 "../../../../../Dev/PIClib/lib/soft/pic32_ringBuffer.c"
void rBufReset(tRBufCtl * bufCtlPtr)
{
 U32 wu0;
 ...
 bufCtlPtr->status.freeElement = bufCtlPtr->control.elementNb;
 bufCtlPtr->control.in = bufCtlPtr->bufPtr;
 bufCtlPtr->control.out = bufCtlPtr->bufPtr;



 for (wu0 = 0; wu0 < (bufCtlPtr->control.elementNb*bufCtlPtr->control.elementSize); wu0++)
  ((U8*)(bufCtlPtr->bufPtr))[wu0] = 0;
...
# 240 "../../../../../Dev/PIClib/lib/soft/pic32_ringBuffer.c"
U8 rBufPushU8(tRBufCtl * bufCtlPtr, U8 * sourcePtr, U16 elementNb, U8 option)
{
 tRBufCtl workBufCtl = *bufCtlPtr;
 U16 elementDone;
 ...
 if (workBufCtl.status.freeElement > elementNb)
 {
  ...
  if (bufCtlPtr->status.writeLock == 0)
  {
    ...
    *((U8*)workBufCtl.control.in) = *sourcePtr;
    ...
    if (workBufCtl.control.in == workBufCtl.control.end)
     workBufCtl.control.in = workBufCtl.bufPtr;
    else
     workBufCtl.control.in++;

   }



   workBufCtl.status.freeElement -= elementNb;
...
# 307 "../../../../../Dev/PIClib/lib/soft/pic32_ringBuffer.c"
U8 rBufPullU8(tRBufCtl * bufCtlPtr, U8 * destinationPtr, U16 elementNb, U8 option)
{
 tRBufCtl workBufCtl = *bufCtlPtr;
 U16 elementDone;
 ...
 if (bufCtlPtr->status.readLock == 0)
 {
  ...
  for (elementDone = 0; elementDone < elementNb; elementDone++)
  {
   *destinationPtr = *((U8*)workBufCtl.control.out);
   ...
   if (workBufCtl.control.out == workBufCtl.control.end)
    workBufCtl.control.out = workBufCtl.bufPtr;
   else
    workBufCtl.control.out++;
...
# 368 "../../../../../Dev/PIClib/lib/soft/pic32_ringBuffer.c"
U8 rBufPushElement(tRBufCtl * bufCtlPtr, void * sourcePtr, U16 elementNb, U8 option)
{
 tRBufCtl workBufCtl = *bufCtlPtr;
 U32 loopDone;
...
# 441 "../../../../../Dev/PIClib/lib/soft/pic32_ringBuffer.c"
U8 rBufPullElement(tRBufCtl * bufCtlPtr, void * destinationPtr, U16 elementNb, U8 option)
{
 tRBufCtl workBufCtl = *bufCtlPtr;
 U32 loopDone;
