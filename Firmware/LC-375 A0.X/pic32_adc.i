# 1 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.c"
# 1 "E:\\Dropbox\\Electro\\Projects\\AQCA\\Light-Module\\Firmware\\LC-375 A0.X//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.c"
# 16 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.c"
# 1 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.h" 1
# 19 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.h"
# 1 "../hardware.h" 1
# 17 "../hardware.h"
...
# 21 "../hardware.h" 2
# 20 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.h" 2
...
# 23 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.h" 2
...
# 24 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.h" 2
# 88 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.h"
typedef enum
{
 ADCidle,
 ADCconfig,
...
# 314 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.h"
void adcISR(U8 adcPort);
# 326 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.h"
U8 adcSelectPort(U8 adcPort);
# 335 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.h"
U8 adcInit(U8 adcPort);
# 345 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.h"
void adcSetInput(tADCMuxInput inputMatrix);
# 358 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.h"
U8 adcSetSampleRate(U8 adcPort, U32 sampleRate);
# 367 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.h"
U32 adcGetSampleRate(U8 adcPort);
# 376 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.h"
U8 adcCalibrate(U8 adcPort);
# 386 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.h"
U8 adcSetScanInput(U8 adcPort, tADCMuxInput scanInput);
# 395 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.h"
tADCMuxInput adcGetScanInput(U8 adcPort);
# 405 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.h"
U8 adcGetScanInputeNb(U8 adcPort);
# 417 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.h"
void adcEnableAveraging(U8 adcPort, U16 sampleNb, U8 inputNb);
# 433 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.h"
U32 adcConvert(U8 adcPort, tADCInput adcInput, U8 conversionNb, U16 * resultPtr, U8 * donePtr);
# 446 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.h"
U8 adcStartScan(U8 adcPort, U16 * resultPtr, U8 * donePtr);
# 455 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.h"
U8 adcStopScan(U8 adcPort);
# 17 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.c" 2
...
U8 __adcSafeDonePtr = 1;


tADxCON1 * pADxCON1 = ((void *)0);
tADxCON2 * pADxCON2 = ((void *)0);
tADxCON3 * pADxCON3 = ((void *)0);
tADxCHS * pADxCHS = ((void *)0);
tADxCSSL * pADxCSSL = ((void *)0);
U32 * pADxBUF = ((void *)0);


const tADCreg * adcRegAddress[1] = {&AD1CON1};
tADCcontrol adcControl[1];
U16 adcResultBuffer[1][16];
# 50 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.c"
void adcISR(U8 adcPort)
{
 ...
 for (wu0 = 0; wu0 < workADC->ADxCON2.SMPI; wu0++)
  adcResultBuffer[adcPort][wu0] = workADC->ADCxBUF[wu0];
...
void adcEngine(U8 adcPort)
{
 ...
 switch (workPtr->state)
 {
  ...
  case ADCcalibration:
  {
   ...
   for (wu0 = 0; wu0 < 10; wu0++)
    tempCal += (pADxBUF[wu0 << 2]);

   workPtr->offsetVal = tempCal/10;
   pADxCON2->OFFCAL = 0;
...
# 152 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.c"
U8 adcSelectPort(U8 adcPort)
{
 switch (adcPort)
 {
  case 0: pADxCON1 = (tADxCON1*)&AD1CON1; pADxCON2 = (tADxCON2*)&AD1CON2; pADxCON3 = (tADxCON3*)&AD1CON3; pADxCHS = (tADxCHS*)&AD1CHS; pADxCSSL = (tADxCSSL*)&AD1CSSL; pADxBUF = (U32*)&ADC1BUF0; break;
  default : return 2;
 }
 return 0;
}
# 169 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.c"
U8 adcInit(U8 adcPort)
{
 ...
 if (errorCode == 0)
 {
  ...
  pADxCON1->ON = 1;
  __asm__ __volatile__ (" move $0,$16" : :);

 }

 return errorCode;
}
# 210 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.c"
void adcSetInput(tADCMuxInput inputMatrix)
{
 ...
 ANSELA = inputMatrix & ((1 << 1)|(1 << 0));
 ANSELBCLR = 0xFFFF;
 ANSELBSET = ((inputMatrix >> 2) & ((1 << 3)|(1 << 2)|(1 << 1)|(1 << 0)));
 ANSELBbits.ANSB12 = splittedMatrix.b12;
 ANSELBbits.ANSB13 = splittedMatrix.b11;
 ANSELBbits.ANSB14 = splittedMatrix.b10;
 ANSELBbits.ANSB15 = splittedMatrix.b9;
# 235 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.c"
}
# 248 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.c"
U8 adcSetSampleRate(U8 adcPort, U32 sampleRate)
{
 U8 adcs = 0;
 U8 samc = 0;
 ...
 if (errorCode == 0)
 {
  ...
  if (pADxCON3->ADRC == 0)
  {
   ...
   for (; (tempPBclock / ((adcs+1) << 1 )) > 15000000; adcs++);



   if ((tempPBclock / (((adcs+1) << 1 ) * (12 +1))) >= sampleRate)
   {


     for (; adcs <= 255; adcs++)
     {
      samc = (tempPBclock / (sampleRate * ((adcs+1) << 1 ))) - 12;

      if ((samc < 31) && ((tempPBclock / ((adcs+1) << 1 )) < 15000000))
       break;
     }
     ...
     while (adcGetSampleRate(adcPort) > 1000000)
      pADxCON3->SAMC++;
...
# 329 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.c"
U32 adcGetSampleRate(U8 adcPort)
{
 U32 sampleRate = 0;

 if (adcSelectPort(adcPort) == 0)
 {

  sampleRate = clockGetPBCLK()/((((pADxCON3->ADCS)+1) <<1) * (12 + pADxCON3->SAMC));

 }

 return sampleRate;
}
# 350 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.c"
U8 adcCalibrate(U8 adcPort)
{
 U8 errorCode = adcSelectPort(adcPort);
...
# 377 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.c"
U8 adcSetScanInput(U8 adcPort, tADCMuxInput scanInput)
{
 U8 errorCode = adcSelectPort(adcPort);
 if (errorCode == 0)
...
# 392 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.c"
tADCMuxInput adcGetScanInput(U8 adcPort)
{
 if (adcSelectPort(adcPort) == 0)
...
# 407 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.c"
U8 adcGetScanInputeNb(U8 adcPort)
{
 U8 wu0;
 U8 inputNb = 0;
...
# 434 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.c"
void adcEnableAveraging(U8 adcPort, U16 sampleNb, U8 inputNb)
{
 tADCcontrol * workPtr = &adcControl[adcPort];
 ...
 if (adcSelectPort(adcPort) == 0)
 {
  ...
  if (workPtr->averagingBuffer != ((void *)0))
...
# 469 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.c"
U32 adcConvert(U8 adcPort, tADCInput adcInput, U8 conversionNb, U16 * resultPtr, U8 * donePtr)
{
 U8 errorCode;
 tADCcontrol * workPtr = &adcControl[adcPort];
 ...
 if (errorCode == 0)
 {
  ...
  if (donePtr == ((void *)0))
   ...
   workPtr->donePtr = donePtr;

  if (resultPtr == ((void *)0))
   return 1;
  else
   workPtr->resultPtr = resultPtr;
...
# 528 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.c"
U8 adcStartScan(U8 adcPort, U16 * resultPtr, U8 * donePtr)
{
 U8 errorCode;
 tADCcontrol * workPtr = &adcControl[adcPort];
 ...
 if (errorCode == 0)
 {
  ...
  pADxCON2->SMPI = adcGetScanInputeNb(adcPort) -1;
...
# 575 "../../../../../Dev/PIClib/lib/peripheral/pic32_adc.c"
U8 adcStopScan(U8 adcPort)
{
 U8 errorCode;
