# 1 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.c"
# 1 "E:\\Dropbox\\Electro\\Projects\\AQCA\\Light-Module\\Firmware\\LC-375 A0.X//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.c"
# 14 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.c"
# 1 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.h" 1
# 19 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.h"
# 1 "../hardware.h" 1
# 17 "../hardware.h"
...
# 21 "../hardware.h" 2
# 20 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.h" 2
...
# 23 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.h" 2
...
# 24 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.h" 2
# 74 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.h"
typedef union
{
 U32 all;
 struct
...
# 137 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.h"
U8 ocSetConfig(U8 ocPort, U32 localOcConfig);
# 146 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.h"
tOCConfig ocGetConfig(U8 ocPort);
# 156 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.h"
U8 ocStart(U8 ocPort);
# 169 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.h"
void pwmSetPeriod(U8 ocPort, U32 newPeriod);
# 178 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.h"
U32 pwmGetPeriod(U8 ocPort);
# 189 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.h"
U8 pwmSetTon(U8 ocPort, U32 timeON);
# 201 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.h"
void pwmSetDuty(U8 ocPort, U32 numerator, U32 denominator);
# 15 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.c" 2





tOCConfig ocConfig[5];
U32 pwmPeriodTime[5];
F32 pwmCntPeriodTime[5];


tOCxCON * pOCxCON = ((void *)0);
U32 * pOCxR = ((void *)0);
U32 * pOCxRS = ((void *)0);
# 39 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.c"
U8 ocSelectPort(U8 ocPort)
{
 switch (ocPort)
 {
  case 0: pOCxCON = (tOCxCON*)&OC1CON; pOCxR = (U32*)&OC1R; pOCxRS = (U32*)&OC1RS; break;
  case 1: pOCxCON = (tOCxCON*)&OC2CON; pOCxR = (U32*)&OC2R; pOCxRS = (U32*)&OC2RS; break;
  case 2: pOCxCON = (tOCxCON*)&OC3CON; pOCxR = (U32*)&OC3R; pOCxRS = (U32*)&OC3RS; break;
  case 3: pOCxCON = (tOCxCON*)&OC4CON; pOCxR = (U32*)&OC4R; pOCxRS = (U32*)&OC4RS; break;
  case 4: pOCxCON = (tOCxCON*)&OC5CON; pOCxR = (U32*)&OC5R; pOCxRS = (U32*)&OC5RS; break;
  default: return 2;
 }
 return 0;
}
# 80 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.c"
U8 ocSetConfig(U8 ocPort, U32 localOcConfig)
{


 if (localOcConfig & ((1 << 5)))
 {
...
# 103 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.c"
tOCConfig ocGetConfig(U8 ocPort)
{
 return ocConfig[ocPort];
}
# 116 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.c"
U8 ocStart(U8 ocPort)
{
 U8 errorCode;
...
# 153 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.c"
void pwmSetPeriod(U8 ocPort, U32 newPeriod)
{
...
# 171 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.c"
U32 pwmGetPeriod(U8 ocPort)
{
 return timerGetOverflow((ocConfig[ocPort].timer)+1);
}
# 185 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.c"
U8 pwmSetTon(U8 ocPort, U32 timeON)
{
 U8 errorCode;
...
# 215 "../../../../../Dev/PIClib/lib/peripheral/pic32_output_compare.c"
void pwmSetDuty(U8 ocPort, U32 numerator, U32 denominator)
{
 U32 tempPR = timerGetPR((ocConfig[ocPort].timer)+1);

 if (ocSelectPort(ocPort) == 0)
 {
